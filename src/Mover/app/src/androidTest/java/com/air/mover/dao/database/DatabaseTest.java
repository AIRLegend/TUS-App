...
public class DatabaseTest {
    ...
    */
    ...
    /*
    Test que comprueba que no se puede añadir un comentario a una parada inexistente
     */
    @Test
    public void U13D() throws Exception{
        try{

            Database.addComment(463,"Camarreal Peñacastillo","Cerca de un buen restaurante",mActivityTestRule.getActivity().getApplicationContext());
            Parada p = Database.getCommentParada(463,"Camarreal Peñacastillo",mActivityTestRule.getActivity().getApplicationContext());

            Assert.assertEquals(null,p.getNombre());
            Assert.assertEquals(null,p.getComentarios());
    ...
    /*
    Test que compruueba que se puede añadir un comentario a una parada existente
     */
    @Test
